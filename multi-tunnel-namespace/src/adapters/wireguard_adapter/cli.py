"""Entry point for WireGuard adapter as a subprocess (two‑tier)."""
...
from libvpnmanager.sessions.wireguard import WireGuardSession
...
async def main():
    ...
    try:
        ...
        session = WireGuardSession.from_dict(session_dict)
